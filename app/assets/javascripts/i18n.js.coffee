class I18n
  @_locales =
    'en':
      ...
      'add_busy_time': 'New Busy Time'
      'edit_busy_time': 'Edit Busy Time'
      'remove_repeat': 'Remove Repeat'
      'add_repeat': 'Add Repeat'
      'location': 'Locations'
      'new_appointment': '<i class="icon-plus"></i> New Appointment'
      'loading': 'Loading...'
      'add_busy_time': 'Add Busy Time'
      'edit_busy_time': 'Edit Busy Time'
      'revert_change': 'Please confirm this change?'
    ...
    'fr':
      ...
      'edit_appointment': 'Édition du rendez-vous'
      'remove_repeat': 'Supprimer la récurrence'
      'add_repeat': 'Répéter'
      'location': 'Magasins'
      'new_appointment': '<i class="icon-plus"></i> Nouveau rendez-vous'
      'loading': 'Chargement...'
      'add_busy_time': 'Inactif le...'
      'edit_busy_time': 'Inactif le...'
      'revert_change': 'Veuillez confirmer ce changement'
