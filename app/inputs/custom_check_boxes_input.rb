  ...
  def input
    ...
    html = template.content_tag(:div, class: "input-group") do
      collection.each do |col|
        buffer += template.content_tag(:div, class: 'checkbox') do
          @builder.collection_check_boxes(attribute_name, [col], value_method, label_method,input_options, input_html_options, &collection_block_for_nested_boolean_style)
        end
      end
