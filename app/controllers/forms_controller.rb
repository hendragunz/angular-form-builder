  ...
  private
    ...
    def safe_params
      params.require(:form).permit(:name, :introduction, :confirmation_message, :max_entries_allowed, :start_date, :end_date, :unique_ip_only, :send_email_confirmation,
                                   ...
                                   properties: [ :description, :true_label, :false_label, :currency, :add_on, :from_number, :to_number, :max_rating, :format, :symbol, :max_number, :min_number, :max_row, :statements => [:name], :columns => [:name]],
